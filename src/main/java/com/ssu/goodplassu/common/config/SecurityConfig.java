	...
	public SecurityFilterChain securityFilterChain(HttpSecurity http, HandlerMappingIntrospector introspector) throws Exception {
		http
				...
				.authorizeHttpRequests(a -> a	// 요청에 대한 접근 제어 설정
						...
						.requestMatchers("/api/members/posts").hasRole(Role.USER.name())
						.requestMatchers("/api/members/likes/posts").hasRole(Role.USER.name())
						.requestMatchers("/api/members/comments/posts").hasRole(Role.USER.name())
						.requestMatchers("/api/members/info").hasRole(Role.USER.name())
						.requestMatchers("/api/auth/logout").hasRole(Role.USER.name())
						.requestMatchers(
